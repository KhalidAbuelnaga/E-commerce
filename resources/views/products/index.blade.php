    ...
    <div class="container mt-4 welcome p-0">
        ...
        <div class="row">
            <div class="list-group col-md-3 pe-md-5 rounded-0">
                <a class="list-group-item list-group-item-action active py-3">Categories</a>
                        ...
                        <div class="card border-0  px-0">
                            <div class="image position-relative">
                                ...
                                <div class="card-img-overlay text-center align-items-center justify-content-center d-flex">
                                    <a href="{{url("products" , $product->id)}}" class="btn btn-outline-light border-2 rounded-circle p-3 fw-medium product_id"><i class="fa-regular fa-eye display-6"></i></a>
                                </div>
                            </div>
                        </div>
